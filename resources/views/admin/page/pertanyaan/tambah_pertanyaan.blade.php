...
@section('sec_halaman', 'HALAMAN TAMBAH PERTANYAAN')

@section('content_admin')
    <div class="row justify-content-center">
        <div class="col-lg-8 col-md-8 col-sm-12">
            <div class="card p-3">
                <h5 class="text-center mb-4">FORM TAMBAH PERTANYAAN</h5>
                <form method="POST" action="/admin/tambah_data_pertanyaan" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
