...
*/
    ...
    Route::prefix('admin')->middleware('auth')->group(function(){
        ...
        Route::get('/tambah_kategori/{id_kategori}',[App\Http\Controllers\KategoriController::class,'tambah_kategori']);
        ...
        Route::get('/ubah_pertanyaan',[App\Http\Controllers\PertanyaanController::class,'ubah_pertanyaan']);
        Route::post('/ubah_data_pertanyaan',[App\Http\Controllers\PertanyaanController::class,'ubah_data_pertanyaan']);
